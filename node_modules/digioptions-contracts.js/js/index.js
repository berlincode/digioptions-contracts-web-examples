...
(function (root, factory) {
  ...
  function contractInfoToContractDescription(web3, contractAddr, contractInfo){
    ...
    var digiOptionsMarketsAddr = contractInfo[3].toHexString(); // TODO real 0x0Eb7e02ED6C8a55f72551E8677eE3bbB25263016 with address with exact 20bytes (maybe with leading zeroes)
    ...
    return {
      ...
      payoutPerNanoOption: web3Utils.toBN('10').pow(atomicOptionPayoutWeiExp),
      nanoOptionsPerOption: web3Utils.toBN('10').pow(web3Utils.toBN('18').sub(atomicOptionPayoutWeiExp)),
  ...
  function getActiveUsers(contract, marketHashes){
    ...
    return contract.getPastEvents('PositionChange', {
      ...
      .then(function(eventsAll){
        var users = new Set(); // TODO Set()
        for (var idx = 0 ; idx < eventsAll.length; idx++){
          var returnValues = eventsAll[idx].returnValues;
          users.add(returnValues.buyer.toHexString().toLowerCase());
          users.add(returnValues.seller.toHexString().toLowerCase());
        }
  ...
  function signOrder(order, privateKey) {  // TODO remove
    var sig = signOfferHash(orderOfferToHash(order), privateKey);
  ...
  var atomicOptionPayoutWeiExp = web3Utils.toBN('9'); // TODO
  ...
  return {
    ...
    signOrder: signOrder,
    // TODO remove
    payoutPerNanoOption: web3Utils.toBN('10').pow(atomicOptionPayoutWeiExp), // == 1000000000 (in wei)
    // TODO remove
    nanoOptionsPerOption: web3Utils.toBN('10').pow(atomicOptionPayoutWeiExp), // == 1000000000
